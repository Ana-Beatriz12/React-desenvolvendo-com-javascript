  ...
  return (// aqui usamos o operador ternario para verificar se colaboradores for maior que 0 , retorna o card, se nao ele esconde os times que nao tem colaboradores 
    ...
    <section className="time" style={cssSecundaria}>
      ...
      <div className="colaboradores">
        {propriedades.colaboradores.map(colaborador => <Colaborador corDeFundoCard={propriedades.corPrimaria} key={colaborador.nome} nome={colaborador.nome} cargo={colaborador.cargo} imagem={colaborador.imagem} />)}
      </div>
    </section> 
    :''
  );
